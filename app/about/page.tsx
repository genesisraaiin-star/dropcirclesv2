    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .hero-label::before{content:'';width:5px;height:5px;border-radius:50%;background:var(--cyan);}
        .hero-title{font-family:var(--serif);font-size:clamp(36px,5vw,64px);line-height:1.05;letter-spacing:-1px;color:var(--white);font-weight:400;margin-bottom:20px;}
        .hero-title em{font-style:italic;color:rgba(245,242,238,0.4);}
        .hero-sub{font-family:var(--mono);font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:var(--gray);max-width:480px;line-height:1.7;}
        .you-block{display:grid;grid-template-columns:1fr 1fr 1fr;border-bottom:1px solid var(--line);}
        .you-col{padding:40px 36px;border-right:1px solid var(--line);}
        .you-col:last-child{border-right:none;}
        .you-verb{font-family:var(--serif);font-size:clamp(22px,3vw,36px);line-height:1.1;color:var(--white);font-weight:400;margin-bottom:10px;}
        .you-desc{font-family:var(--mono);font-size:9px;letter-spacing:1.5px;text-transform:uppercase;color:var(--gray);line-height:1.8;}
        .strip{display:grid;grid-template-columns:1fr 1fr 1fr;border-bottom:1px solid var(--line);}
        .s-col{padding:28px 32px;border-right:1px solid var(--line);position:relative;overflow:hidden;}
        .s-col:last-child{border-right:none;}
        .s-num{position:absolute;top:-8px;left:-4px;font-family:var(--serif);font-size:100px;color:rgba(245,242,238,0.03);font-weight:400;line-height:1;pointer-events:none;user-select:none;}
        .s-text{position:relative;z-index:1;font-family:var(--mono);font-size:9px;letter-spacing:1.5px;text-transform:uppercase;color:var(--gray);line-height:1.9;}
        .light{background:var(--off);color:#0a0a0a;}
        .two-col{display:grid;grid-template-columns:1fr 1fr;min-height:560px;}
        ...
        .r3{width:70px;height:70px;top:65px;left:65px;border-color:rgba(10,10,10,0.5);}
        .r-core{width:24px;height:24px;top:88px;left:88px;background:#0a0a0a;border-color:#0a0a0a;animation:corePulse 3s cubic-bezier(0.25,0.1,0.25,1) infinite;}
        ...
        .rl-1{top:-12px;}.rl-2{top:20px;color:#888;}.rl-3{top:59px;color:#0a0a0a;}
        .tier-rows{width:100%;max-width:260px;}
        .tier-row{display:grid;grid-template-columns:1fr auto;padding:10px 0;border-bottom:1px solid var(--linelt);transition:padding-left 0.2s ease,background-color 0.2s ease;cursor:crosshair;}
        .tier-row:last-child{border-bottom:none;}
        .tier-row:hover:nth-child(1){padding-left:8px;background-color:#faf5e6;}
        .tier-row:hover:nth-child(2){padding-left:8px;background-color:#fdf5f7;}
        .tier-row:hover:nth-child(3){padding-left:8px;background-color:#f0f7f4;}
        ...
        @media(max-width:768px){
          ...
          .you-block,.strip{grid-template-columns:1fr;}
          .you-col{border-right:none;border-bottom:1px solid var(--line);}
          .you-col:last-child{border-bottom:none;}
          .s-col{border-right:none;border-bottom:1px solid var(--line);}
          .s-col:last-child{border-bottom:none;}
          .two-col{grid-template-columns:1fr;min-height:unset;}
          .col-l{padding:36px 24px;border-right:none;border-bottom:1px solid var(--linelt);}
      ...
      <nav className="nav grain">
        ...
        <Link href="/" className="nav-back">← Request access</Link>
      </nav>

      <div className="hero grain">
        <div className="hero-label">About the platform</div>
        <h1 className="hero-title">The ecosystem<br/>for <em>the drop before<br/>the drop.</em></h1>
        <div className="hero-sub">A closed-circuit infrastructure built for artists who are done asking permission. Here is everything you need to know.</div>
      </div>

      <div className="you-block grain">
      ...
      <div className="strip grain">
        <div className="s-col">
          ...
          <div className="s-text">Three circles. Inner Circle, Wave, Street. You control who gets in, when they get in, and what they pay.</div>
        </div>
        <div className="s-col">
          <div className="s-num">02</div>
          <div className="s-text">Direct-to-vault drops. Your superfans pay you — before the world gets access.</div>
        </div>
        <div className="s-col">
          <div className="s-num">03</div>
          <div className="s-text">We take 5%. Patreon takes 12%. Bandcamp takes 15%. The math is not close.</div>
        </div>
      </div>
